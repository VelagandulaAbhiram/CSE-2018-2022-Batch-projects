...
main = tkinter.Tk()
main.title("Performance Evaluation")
...
font = ('times', 16, 'bold')
title = Label(main, text='Performance Comparison of Support Vector Machine, Random Forest, and Extreme Learning Machine for Intrusion Detection')
